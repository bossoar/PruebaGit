...
public class repoMemFiscFecha extends ifCommand {
    ...
    public repoMemFiscFecha() {
        ...
        this.descripcionComando = "Este comando imprime un reporte de Cierres Diarios en forma selectiva por un rango de fechas. Este comando usa tiempo extendido para su finalizaciÃ³n. AdemÃ¡s brinda la opciÃ³n de producir sÃ³lo totales, o totales y detalles de Cierres Diarios.";
