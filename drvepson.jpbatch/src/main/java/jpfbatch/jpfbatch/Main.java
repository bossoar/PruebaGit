...
import jpfbatch.jpfbatch.tests.IFTest;
...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        if (pub.hasOption("help") || pub.hasOption("Help")) {
            ...
            jpfbatch.jpfbatch.net.TCPServer server = new jpfbatch.jpfbatch.net.TCPServer((Integer) pub.getOptValue("TimeOut"), pub.config);
            ...
            if (pub.hasOption("InFileName") && !((String) pub.getOptValue("InFileName")).isEmpty()) {
                ...
                jpfbatch.jpfbatch.net.TCPClient client = new jpfbatch.jpfbatch.net.TCPClient(loadFile((String) pub.getOptValue("InFileName")));
