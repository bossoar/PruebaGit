 ...
 */
package jpfbatch.jpfbatch.tests;

import ifepson.ifepson.commands.abrirTique;
import ifepson.ifepson.commands.cerrarTique;
import ifepson.ifepson.commands.imprItemTique;
import ifepson.ifepson.commands.imprTxtFiscTique;
import ifepson.ifepson.commands.pagoCancelDescRecaTique;
import ifepson.ifepson.commands.subtotalTique;
import ifepson.ifepson.doc.IndexedOut;
import ifepson.ifepson.ifCommand;
import java.io.IOException;
import java.util.Map;
import jpfbatch.jpfbatch.IFBatch;
